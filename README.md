...
This project used the California Housing dataset within the sklearn.datasets package in Python. 
...
4. Run the boxplot.py script by doing: python src/boxplot.py

After doing this, you should see an image in the repository's figs folder. This figure should be a single boxplot of the median home value for the California Housing dataset. 
